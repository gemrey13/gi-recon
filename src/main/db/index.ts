...
export function initDb() {
  ...
  db.exec(`
    CREATE TABLE IF NOT EXISTS grab_transactions (
      ...
      -- Identity & Reference
      merchant_name TEXT, merchant_id TEXT,
      store_name TEXT, store_id TEXT,
      updated_on TEXT, created_on TEXT,
      ...
      -- Channel & Payment
      order_channel TEXT, order_type TEXT, payment_method TEXT,
      receiving_account_source_of_fund TEXT,
      terminal_id TEXT, channel TEXT, offer_type TEXT,
      
      -- Commissions & Points
      grab_fee_percent REAL, points_multiplier REAL, points_issued REAL,
      settlement_id TEXT, transfer_date TEXT,
      
      -- Financial Breakdown
      amount REAL, tax_on_order_value REAL,
      restaurant_packaging_charge REAL, non_member_fee REAL,
      restaurant_service_charge REAL, offer REAL,
      discount_merchant_funded REAL, delivery_fee_discount_merchant_funded REAL,
      delivery_charge_grab_online_store REAL, delivery_charge_merchant_delivery REAL,
      grab_express_delivery_service_fee REAL,
      net_sales REAL, net_mdr REAL, tax_on_mdr REAL, grab_fee REAL,
      marketing_success_fee REAL, delivery_commission REAL,
      channel_commission REAL, order_commission REAL,
      grab_food_mart_other_commission REAL, grab_kitchen_commission REAL,
      grab_kitchen_other_commission REAL, withholding_tax REAL,
      total REAL, 
      tax_on_mdr_percent REAL, delivery_commission_percent REAL,
      channel_commission_percent REAL, order_commission_percent REAL,
      tax_on_grab_food_commission_adjustments_ads REAL, tax_on_total REAL,
      
      -- Cancellation & Incidents
      cancellation_reason TEXT, cancelled_by TEXT,
      reason_for_refund TEXT, description TEXT,
      incident_group TEXT, incident_alias TEXT,
      customer_refunded_item TEXT, appeal_link TEXT,
      appeal_status TEXT, package_voucher_used TEXT,
