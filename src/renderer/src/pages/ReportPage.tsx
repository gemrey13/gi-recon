...
function ReconSummaryTable({ data }: { data: Record<string, unknown>[] }) {
...
function DiscrepancyTable({ data }: { data: Record<string, unknown>[] }) {
...
function UnmatchedTable({ data }: { data: Record<string, unknown>[] }) {
